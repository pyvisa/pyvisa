...
session handle in the instance attribute~\var{vi}.  Thus you can write
\begin{verbatim}
from pyvisa import *
my_instrument = GpibInstrument(14)
...
stored in \var{resource_manager.session}:
\begin{verbatim}
from pyvisa import *
...
if you use Windows, it may be convenient to install
\ulink{Enthought Python}{http://www.enthought.com/python/}.  It is a special
Python version with all-included philosophy for scientific and engineering
applications.\footnote{Of course, it's highly advisable not to have installed
  another version of Python on your system before you install
  Enthought-Python.}
