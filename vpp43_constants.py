...
"completion_and_error_messages" is a dictionary that binds every completion and
error value to its name and a short textual description (both in a two-elements
tuple).
"""
