...
class RegisterBasedResource(Resource):
    ...
    def read_memory(self, space, offset, width, extended=False):
        ...
        """
        return self.visalib.read_memory(self.session, space, offset, width,
                                        extended)

    def write_memory(self, space, offset, data, width, extended=False):
        """Write in an 8-bit, 16-bit, 32-bit, value to the specified memory
        space and offset.
        ...
        """
        return self.visalib.write_memory(self.session, space, offset, data,
                                         width, extended)
    ...
    def move_in(self, space, offset, length, width, extended=False):
        ...
        """
        return self.visalib.move_in(self.session, space, offset, length, width,
                                    extended)
    ...
    def move_out(self, space, offset, length, data, width, extended=False):
        ...
        """
        return self.visalib.move_out(space, offset, length, data, width,
                                     extended)
